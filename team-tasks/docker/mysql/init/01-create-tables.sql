-- Team Tasks Database Schema
-- This script creates all necessary tables for the team-tasks application
...
INSERT IGNORE INTO assignees (id, name, email, phone, role, department, avatar, join_date, tasks_completed, current_tasks, overdue_tasks) VALUES
...
INSERT IGNORE INTO tasks (id, title, description, priority, status, assignee_id, assignee_name, due_date) VALUES
